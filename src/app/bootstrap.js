...
export async function bootstrapApp(){
  ...
  window.AbsenApp=Object.freeze({store,router,features,attendanceExperience,version:'10.0.0'});
  ...
  window.dispatchEvent(new CustomEvent('absen:app-ready',{detail:{version:'10.0.0',features:features.names()}}));
}
