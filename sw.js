const CACHE = 'absen-sppg-hadirly-v81';
const APP_VERSION = '26.11.40';
...
const SHELL = [
  ...
  `./src/app/id-card-front-signature-renderer.js?v=${APP_VERSION}`,
  ...
  `./src/styles/pages/id-card-front-signature.css?v=${APP_VERSION}`,
  `./src/styles/pages/digital-id-card-master-renderer.css?v=${APP_VERSION}`,
  ...
  `./src/features/sppg-location-config.js?v=${APP_VERSION}`
];
