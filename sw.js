const CACHE = 'absen-sppg-hadirly-v77';
const APP_VERSION = '26.11.36';
...
const SHELL = [
  ...
  `./src/app/digital-id-card-print-sync.js?v=${APP_VERSION}`,
  ...
  `./src/styles/pages/digital-id-card-v2.css?v=${APP_VERSION}`,
